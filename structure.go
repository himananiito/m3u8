...
type MediaPlaylist struct {
	...
	StartOffset        *float64 // #EXT-X-START:TIME-OFFSET=0.0
	StreamDuration     *float64 // #STREAM-DURATION
	CurrentPosition    *float64 // #CURRENT-POSITION
	DMCStreamDuration  *float64 // #DMC-STREAM-DURATION Dwango Media Cluster
	DMCCurrentPosition *float64 // #DMC-CURRENT-POSITION Dwango Media Cluster
}
